          ...
          <div className="row justify-content-between">
              ...
              <form>
                ...
                <div className="row">
                  <div className="col-lg-6 mil-mb-30">
                    <div className="mil-input-frame mil-dark-input mil-mb-30">
                      <label className="mil-h6 mil-dark">
                        <span>Project Design / Development</span>
                      </label>
            ...
            <div className="col-lg-4 col-xl-3 mil-mb-120">
              ...
              <div className="mil-mb-60">
                ...
                <p>We are open to collaborate with you.</p>
              </div>
              <div className="mil-divider mil-mb-60" />
              <Link
                href="javascript:void(0)"
              ...
              <br />
              <Link href="javascript:void(0)" className="mil-link mil-link-sm">
          ...
          <div className="row">
            <div className="col-xl-6">
              <div className="mil-mb-60">
                ...
                <h5 className="mil-list-title mil-mb-15">Lahore</h5>
                <p className="mil-mb-30">Garden Town, Street No 1</p>
                <div className="mil-divider mil-divider-left mil-mb-30" />
                <h6 className="mil-mb-15">
                  <span className="mil-accent">+ 92 </span> 305 7017 943
                </h6>
                {/* <h6>
            ...
            <div className="col-xl-6">
              <div className="mil-mb-60">
                <h4 className="mil-mb-30">UAE</h4>
                <h5 className="mil-list-title mil-mb-15">Dubai</h5> 
                <p className="mil-mb-30">Discovery Garden Dubai, UAE</p>
                <div className="mil-divider mil-divider-left mil-mb-30" />
                <h6 className="mil-mb-15">
                  <span className="mil-accent">+ 97</span> 155 6362 091
                </h6>
                {/* <h6>
