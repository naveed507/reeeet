  ...
  return (
    <footer className="mil-dark-bg">
        ...
        <div className="mil-footer-content mil-p-120-90">
          <div className="row justify-content-between align-items-center">
            <div className="col-xl-4 mil-mb-30">
              ...
              /> */}
              <h3>
                <span style={{ color: "white" }}>Invonix</span>
                <span className="mil-accent">Tech</span>
              </h3>
              <p className="mil-light-soft mil-mb-30">
                Whether you're a startup aiming for a digital breakthrough or an
                established business seeking IT solutions, InvonixTech is here
                to empower your success.
              </p>
              <a href="#." className="mil-app-btn mil-mb-5">
                <i className="fab fa-google-play" />
                <div className="mil-app-text">
                  <span className="mil-accent mil-text-sm">Coming Soon</span>
            ...
            <div className="col-xl-7 mil-mt-60-adapt">
              <div className="row">
                <div className="col-lg-7 mil-mb-30">
                  <h4 className="mil-light mil-up-font mil-mb-30">
                    Join The <span className="mil-accent">InvonixTech</span>{" "}
                    <br />
                    Experience
                  </h4>
                  <p className="mil-light-soft">
                    Let's embark on a journey of <br />
                    collaboration, innovation, and <br /> digital transformation
                    together.
                  </p>
                </div>
      ...
      <div className="mil-footer-bottom">
        <div className="container">
          <p className="mil-text-sm mil-light">© InvonixTech 2024.</p>
